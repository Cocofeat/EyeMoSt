...
from baseline_models import Res2Net2D,ResNet3D,Multi_ResNet,Multi_EF_ResNet,Multi_CBAM_ResNet,Multi_dropout_ResNet,Multi_ensemble_ResNet,Multi_ensemble_3D_ResNet
...
if __name__ == "__main__":
    ...
    parser.add_argument('--end_epochs', type=int, default=100, metavar='N',
                        help='number of epochs to train [default: 500]')
    parser.add_argument('--test_epoch', type=int, default=97, metavar='N',
                        help='number of epochs to train [default: 500]')
    ...
    parser.add_argument("--model_name", default="Multi_ResNet", type=str, help="ResNet3D/Res2Net2D/Multi_ResNet/Multi_dropout_ResNet/Multi_DE_ResNet/Multi_CBAM_ResNet/Multi_EF_ResNet")
    parser.add_argument("--model_base", default="cnn", type=str, help="cnn/transformer")
    ...
    if args.model_name =="ResNet3D":
        ...
        # args.modalties = len(args.dims)
        model = Multi_ResNet(args.num_classes, args.modal_number, args.dims, args.lambda_epochs)
    elif args.model_name == "Multi_DE6_ResNet":
        args.lr = 0.0003
        args.modalties_name = ["FUN", "OCT"]
        model = Multi_ensemble_ResNet(args.num_classes, args.modal_number, args.dims, args.lambda_epochs)
    elif args.model_name == "Multi_DE7_ResNet":
        args.lr = 0.001
        args.modalties_name = ["FUN", "OCT"]
        model = Multi_ensemble_3D_ResNet(args.num_classes, args.modal_number, args.dims, args.lambda_epochs)
    elif args.model_name == "Multi_DE8_ResNet":
        args.lr = 0.003
        args.modalties_name = ["FUN", "OCT"]
        model = Multi_ensemble_3D_ResNet(args.num_classes, args.modal_number, args.dims, args.lambda_epochs)
